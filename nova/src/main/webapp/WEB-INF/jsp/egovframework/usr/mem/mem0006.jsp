...
<script type="text/javaScript">
	...
	function loadCooperatorUsrList(){
        ...
        axios.post('${pageContext.request.contextPath}/usr/mem0006_0001.do',params).then(function(response) {
        	// 로딩 종료
	...
	function saveUser(){
		...
		setTimeout(function(){
			...
			// 로딩 시작
	        $('.loading-wrap--js').show();
	        axios.post('${pageContext.request.contextPath}/usr/mem0006_0002.do',getEditRows(grid)).then(function(response) {
	        	// 로딩 종료
	            $('.loading-wrap--js').hide();
