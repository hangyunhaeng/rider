...
<head>
	...
	let data;
	var columnDefs= [
		{ headerName: "NO", field: "no", minWidth: 60, valueGetter:(params) => { return params.node.rowIndex + 1} },
		...
		{ headerName: "라이더아이디", field: "mberId", minWidth: 100},
		{ headerName: "라이더명", field: "mberNm", minWidth: 100},
		...
		{ headerName: "배달비", field: "deliveryPrice", minWidth: 130, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.deliveryPrice)}},
		{
		    headerName: '콜수수료',
		    children: [
		    	{ headerName: "합계", field: "costC", minWidth: 100, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.costCOper+params.data.costCCoop)}},
				{ headerName: "운영사<br/>콜수수료", field: "costCOper", minWidth: 100, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.costCOper)}},
				{ headerName: "협력사<br/>콜수수료", field: "costCCoop", minWidth: 100, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.costCCoop)}}
		    ]
		},
		{
		    headerName: '프로그램료',
		    children: [
		    	{ headerName: "합계", field: "costP", minWidth: 100, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.costPOper+params.data.costPSale)}},
				{ headerName: "운영사<br/>프로그램료", field: "costPOper", minWidth: 100, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.costPOper)}},
				{ headerName: "영업사원<br/>프로그램료", field: "costPSale", minWidth: 100, cellClass: 'ag-cell-right', valueGetter:(params) => { return currencyFormatter(params.data.costPSale)}}
		    ]
		}
	...
	function doSearch(){
		...
		// 로딩 시작
        $('.loading-wrap--js').show();
        axios.post('${pageContext.request.contextPath}/usr/sts0003_0001.do',params).then(function(response) {
        	// 로딩 종료
            $('.loading-wrap--js').hide();
