...
<script type="text/javaScript">
	...
	var columnDefs= [
		...
		{ headerName: "협력사이름", field: "cooperatorNm", minWidth: 90, editable: true
			, cellClass: (params) => {return agGrideditClass(params)}},
		{ headerName: "사업자등록번호", field: "registrationSn", minWidth: 90, editable: (params) => {return ('${loginVO.authorCode}' == 'ROLE_ADMIN')? true: false}
            , valueParser: (params) => {
...
<body class="index-page">
			...
			<nav id="navmenu" class="navmenu">
				<ul>
					...
					<li class="dropdown"><a href="" onclick="javascript:return false;" class="active"><span>라이더/협력사 현황</span><i class="bi bi-chevron-down toggle-dropdown"></i></a>
						<ul>
							<li style="display:none;"><a href="${pageContext.request.contextPath}/usr/mem0001.do" class="active">협력사관리</a></li>
	...
	<main class="main" style="height: 60px;">
		...
		<section id="hero" class="hero section dark-background"
			style="min-height: 50px; padding: 70px 0 60px 0;">
		...
		<div class="search_box ty2">
			...
			<div style="float: left; width: 49%; margin-right: 1%">
				<div style="height: 0px;">
					<span class="pagetotal" style='margin-right: 20px;'>협력사 : 미사용으로 변경시 하위 모든 라이더 출금이 막힘</span>
					<div class="btnwrap">
