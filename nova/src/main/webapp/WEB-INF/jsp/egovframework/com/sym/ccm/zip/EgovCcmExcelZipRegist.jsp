...
<table  class="table-search">
 <tr>
  ...
  <c:if test ="${searchList == '2'}">
	...
	</td> <!-- 우편번호 도로명주소 엑셀파일 등록 -->
  </c:if>
 </tr>
</table>

<!-- 등록  폼 영역  -->
<table class="tbl_note" class="table-register" summary="<spring:message code="comSymCcmZip.zipVO.summaryExcel"/>"> <!-- 우편번호 엑셀파일을 첨부할 수 있는 등록 테이블입니다. -->
