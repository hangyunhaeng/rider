...
<script type="text/javaScript" src="<c:url value='/js/egovframework/com/sym/mnu/mcm/EgovMenuCreat.js' />"></script>
<script type="text/javaScript">
<!--
/* ********************************************************
 * 조회 함수
...
<%-- <table width="717" class="table-search">
 <tr>
...
<table width="717" cellspacing="1">
 <tr>
  <td width="100%">
    <table cellspacing="1" class="table-register" summary="메뉴생성 검색조건" >
