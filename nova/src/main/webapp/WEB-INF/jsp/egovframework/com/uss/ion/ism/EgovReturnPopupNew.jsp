...
<script type="text/javaScript">
	...
	* 반려 처리화면
	******************************************************** */
	function fncPopUpReturn(returnResn,cmd) {
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input class="s_submit" type="submit" value="<spring:message code="comUssIonIsm.infrmlSanctnDetail.confmAtR" />" onclick="fncPopUpReturn(returnResn,cmd); return false;" /> <!-- 반려 -->
