...
<!-- 상단 타이틀  영역 -->
  ...
  <c:if test="${searchList == '1'}">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;${titleZip }

  </c:if>
  <c:if test="${searchList == '2'}">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;${titleRdmn }
  </c:if>
  </h1>
...
<tbody>
  <c:if test="${searchList == '1'}">
	  ...
	  <tr>
	    <th class="ic_none"><label for="ctprvnNm">${title} <span class="pilsu">*</span></label></th>
	    <td>
	  ...
	  <tr>
	    <th class="ic_none"><label for="signguNm">${title} <span class="pilsu">*</span></label></th>
	    <td>
	  ...
	  <tr>
	    <th class="ic_none"><label for="emdNm">${title} <span class="pilsu">*</span></label></th>
	    <td>
  ...
  <c:if test="${searchList == '2'}">
	  ...
	  <c:set var="title"><spring:message code="comSymCcmZip.zipVO.rdmnCode"/></c:set>
  	  <tr>
	    <th class="ic_none"><label for="rdmnCode">${title} <span class="pilsu">*</span></label></th>
	    <td>
	  ...
	  <tr>
	    <th class="ic_none"><label for="rdmn">${title} <span class="pilsu">*</span></label></th>
	    <td>
...
<div class="txt-cnt mt20">
  ...
  <input type="submit" class="btnStyle02" value="<spring:message code="button.create" />" onclick="fn_egov_regist_Zip(document.zip); return false;"> <!-- 등록 -->
