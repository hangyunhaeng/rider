...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight= "0">
    <div id="new_footer">
    	<ul>
    		...
    		<li style="font-size:11px; float:left; margin: 10px"><spring:message code="comSymMnuMpm.main_bottom.address"/>
    		© Ministry of the Interior and Safety. All rights reserved33333333333333.</li>
    	</ul>
    </div>
</body>
</html>