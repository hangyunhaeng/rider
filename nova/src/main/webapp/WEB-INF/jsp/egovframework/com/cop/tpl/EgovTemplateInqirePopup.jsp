...
<input type="hidden" name="tmplatId" value="" />
	<table class="table-search">
	 <tr>
	  ...
	  <th width="10%">
	   <table>
	    <tr>
	      <td><input name="typeFlag" type="hidden" value="<c:out value='${typeFlag}'/>"/><img src="${ImgUrl}btn/bu2_left.gif"  width="8" height="20" alt="버튼이미지"></td>
	...
	<table class="table-line" summary="번호, 템플릿명, 템플릿구분, 템플릿경로, 사용여부, 등록일자, 선택   목록입니다"  >
	 <thead>
	  <tr>
