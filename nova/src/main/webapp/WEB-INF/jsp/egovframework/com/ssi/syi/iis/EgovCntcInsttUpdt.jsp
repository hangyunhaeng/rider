...
<title><spring:message code="comSsiSyiIis.cntcInsttUpdt.title" /></title>
<!-- 연계기관 수정 -->
...
<validator:javascript formName="cntcInstt" staticJavascript="false"
	...
	<div id="content" style="width: 712px">
		...
		<form:form modelAttribute="cntcInstt" name="cntcInstt" method="post">
			...
			<div class="wTableFrm">
				<!-- 타이틀 -->
				<h2>
					<spring:message code="comSsiSyiIis.cntcInsttUpdt.pageTop.title" />
				</h2>
				<!-- 연계기관 수정 -->
				...
				<table class="wTable">
					...
					<tr>
						<th><spring:message code="comSsiSyiIis.cntcInsttUpdt.insttId" />
							<span class="pilsu">*</span></th>
						<!-- 기관ID -->
						<td class="left"><c:out value='${cntcInstt.insttId}' />&nbsp;
						</td>
					</tr>
					<tr>
						<th><spring:message code="comSsiSyiIis.cntcInsttUpdt.insttNm" />
							<span class="pilsu">*</span></th>
						<!-- 기관명 -->
						<td class="left"><form:input path="insttNm" size="60"
								maxlength="60"
								title="<spring:message code='comSsiSyiIis.cntcInsttUpdt.insttNm'/>" />
							<!-- 기관명 --> <form:errors path="insttNm" /></td>
					</tr>
				</table>
				...
				<div class="btn">
					<input class="s_submit" type="submit"
						...
						onclick="fn_egov_modify_CntcInstt(document.cntcInstt)" />
					<!-- 저장 -->
					<span class="btn_s"><a
						href="<c:url value='/ssi/syi/iis/getCntcInsttList.do'/>"
						onclick=""><spring:message code="button.list" /></a></span>
					<!-- 목록 -->
				</div>
