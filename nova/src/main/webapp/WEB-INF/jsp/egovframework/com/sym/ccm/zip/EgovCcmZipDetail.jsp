...
<table class="tbl_note" summary="<spring:message code="comSymCcmZip.zipVO.summaryDetail"/>"> <!-- 우편번호, 시도명, 시군구명, 읍면동명, 리건물명, 번지동호를 가지고 있는 우편번호 상세조회 테이블이다. -->
...
<input class="btnStyle02" type="submit" value="<spring:message code="button.update" />" onclick="fn_egov_modify_Zip(); return false;">
<input class="btnStyle02" type="submit" value="<spring:message code="title.delete" />" onclick="fn_egov_delete_Zip(); return false;">
<input class="btnStyle02" type="submit" value="<spring:message code="button.list" />" onclick="fn_egov_list_Zip(); return false;">
</div>
