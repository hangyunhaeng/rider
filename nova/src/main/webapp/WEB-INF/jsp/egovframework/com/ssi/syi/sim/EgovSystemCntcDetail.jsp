...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<input class="s_submit" type="submit" value="<spring:message code="button.list" />" title="<spring:message code="button.list" />" onclick="fn_egov_list_SystemCntc(); return false;"><!-- 목록 -->
		</form>
	</div>
