...
<div class="popup">
	...
	<tr>
		...
		<td>
			<button class="btn_s2" onClick="fn_egov_select_popup('${status.count}', '${resultInfo.eventId}');return false;" title="<spring:message code="button.select" /> <spring:message code="input.button" />"><spring:message code="button.select" /></button>
