...
<!-- IE
<iframe name="ifcal" src="<c:url value='/sym/cal/callCal.do'/>" style="width:252px; height:175px;"></iframe>
-->
<!-- FIREFOX -->
<iframe name="ifcal" src="<c:url value='/sym/cal/callCal.do'/>" style="width:290px; height:191px;" title="달력호출"></iframe>
