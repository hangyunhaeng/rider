...
for(int index = 1; index <= endDay; index++)
{
	...
	out.println("<td>");
%>
					<a href="<c:url value='/cop/smt/lsm/mng/addLeaderSchdul.do' />?schdulBgnDe=<%=iUseDate%>&amp;schdulEndDe=<%=iUseDate%>&amp;searchMode=MONTH&amp;year=<%=year%>&amp;month=<%=month%>"
						target="_parent" onclick="JavaScript:fn_egov_regist_LeaderSchdul('<%=iUseDate%>');">
