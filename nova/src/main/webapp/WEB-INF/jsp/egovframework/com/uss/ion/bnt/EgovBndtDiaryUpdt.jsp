...
<title><spring:message code="comUssIonBnt.bndtDiaryUpdt.title"/></title><!-- 당직일지  수정 -->
...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				<span class="btn_b"><a href="" onclick="fncUpdtBndtDiary(); return false;"><spring:message code="button.save" /></a></span>
