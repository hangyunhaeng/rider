...
<tr>
    <td colspan="2">
    	...
    	<td style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;background-color:#E3E3E3;">
    		...
    		<textarea name="${QestmInfo.qestnrQesitmId}" id="${QestmInfo.qestnrQesitmId}" class="textarea"  cols="75" rows="4"  style="width:99%;" title="<spring:message code='comUssOlpQri.title.inputSubjQuest'/>"></textarea><!-- title="주관식내용입력" -->
    		</c:if>
	    </td>
    	</tr>
    	</table>
