...
<div class="wTableFrm">
	...
	<ol class="twit_list mt20">
		...
		<li>	<img src="<c:url value='/images/egovframework/com/uss/ion/tir/twitter_developer.png'/>" alt="트위터 어플 등록 사이트 이미지" title="트위터 어플 등록 사이트"></li>
		<li>2) Developer Portal  <spring:message code="ussIonTir.twitterMain.buttonClick"/><br><!-- 버튼을 클릭하고 등록 페이지에 아래와 같이 트위터 어플리케이션 서비스를 등록한다. -->
			<ul style = "margin: 20px 0;">
				<li><h3 style="margin: 10px 0;">※<spring:message code="ussIonTir.twitterMain.notice" />※</h3></li>
