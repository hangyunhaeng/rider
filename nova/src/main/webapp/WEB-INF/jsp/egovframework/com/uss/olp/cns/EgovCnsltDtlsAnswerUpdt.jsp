		...
		<tr>
			...
			<td class="nopd">
				...
				<input name="emailAnswerAt" type="checkbox" disabled value="Y" <c:if test="${result.emailAnswerAt == 'Y'}">checked</c:if> title="<spring:message code="comUssOlpCns.regist.emailAt"/>"><spring:message code="comUssOlpCns.regist.emailAt"/><!-- 이메일답변여부 -->
  			    ...
  			    &nbsp;&nbsp;&nbsp;
				<a href="<c:url value='/images/egovframework/com/cmm/icon/search2.gif'/>" onClick="javascript:fn_egov_pop_mailform(); return false;" title="발송메일 등록 팝업">
				    <img src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif'/>" alt="발송메일 등록 팝업"/>
				</a>
 				</c:if>
			</td>
		</tr>
