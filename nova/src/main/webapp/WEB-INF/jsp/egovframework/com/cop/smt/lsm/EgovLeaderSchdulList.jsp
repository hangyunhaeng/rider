...
<div id="content" style="width:712px">
	...
	<!-- 상단 텝 -->
	<%--
	<table      summary="간부일정목록의 보기방식을 지정합니다.">
	<tr>
	...
	<!-- iframe -->
	<iframe id="SchdulView" name="SchdulView" src="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulMonthList.do' />" width="100%" height="670px" title="월별/주별/일별 간부일정목록">
	</iframe>
	<!-- //iframe -->
