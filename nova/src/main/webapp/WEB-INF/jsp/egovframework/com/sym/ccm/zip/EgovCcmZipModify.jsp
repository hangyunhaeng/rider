...
<h1>
  ...
  <c:set var="titleRdmn"><spring:message code="comSymCcmZip.zipVO.rdmnUpdate"/></c:set>
    <c:if test="${searchList == '1'}">
     <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle">&nbsp;${titleZip }
    </c:if>
    <c:if test="${searchList == '2'}">
     <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle">&nbsp;${titleRdmn }
    </c:if>
</h1>
<!-- 등록  폼 영역  -->
<table class="tbl_note" summary="<spring:message code="comSymCcmZip.zipVO.summaryInsert"/>"> <!-- 리건물명과 번지동호를 수정하는 우편번호 수정 테이블이다. -->
