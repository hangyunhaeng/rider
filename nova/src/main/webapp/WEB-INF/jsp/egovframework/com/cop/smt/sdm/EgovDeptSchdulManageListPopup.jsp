...
<div class="board">
	...
	<tr>
		...
		<td><button class="btn_s2" onClick="fn_egov_open_Popup('${status.count}', '${resultInfo.schdulId}');return false;" title="<spring:message code="button.select" /> <spring:message code="input.button" />"><spring:message code="button.select" /></button>
		<input name="iptText_${status.count}" id="iptText_${status.count}" type="hidden" value="${resultInfo.schdulNm}"></td>
	</tr>
	</c:forEach>
	</tbody>
	</table>
