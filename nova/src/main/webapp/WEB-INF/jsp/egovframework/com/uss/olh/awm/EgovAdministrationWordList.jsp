...
function fn_egov_select_linkPage(pageNo){
	...
	document.administrationWordForm.action = "<c:url value='/uss/olh/awm/selectAdministrationWordList.do'/>";
...
function fn_egov_inquire_administrationworddetail(administWordId) {
	...
	document.administrationWordForm.administWordId.value = administWordId;
  	document.administrationWordForm.action = "<c:url value='/uss/olh/awm/selectAdministrationWordDetail.do'/>";
  	document.administrationWordForm.submit();
}
</script>
</head>
