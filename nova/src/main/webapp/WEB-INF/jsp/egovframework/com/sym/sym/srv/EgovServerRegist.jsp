...
function fncServerInsert() {
    ...
    if(confirm("<spring:message code="comSymSymSrv.serverRegist.validate.save"/>")){ //저장 하시겠습니까?
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="comSymSymSrv.serverRegist.serverNm"/> <span class="pilsu">*</span></th><!-- 서버S/W 명 -->
			<td class="left">
			    <label for="serverNm"><input name="serverNm" id="serverNm" type="text" maxLength="23" style="width:200px" />&nbsp;<form:errors path="serverNm" /></label>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th><spring:message code="comSymSymSrv.serverRegist.regstYmd"/> <span class="pilsu">*</span></th><!-- 등록일자 -->
			<td class="left">
			    <label for="regstYmd">
		            ...
		            <input type="text" name="regstYmd" id="regstYmd" maxlength="10" title="<spring:message code="comSymSymSrv.serverRegist.regstYmd"/>" style="width:70px" /><!-- 등록일자 -->
