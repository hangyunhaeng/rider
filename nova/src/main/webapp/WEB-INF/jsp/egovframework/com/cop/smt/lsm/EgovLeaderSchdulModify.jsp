...
<title><spring:message code="comCopSmtLsm.leaderSchdulModify.title" /></title><!-- 간부일정관리 수정 -->
...
<form:form modelAttribute="leaderSchdulVO" name="leaderSchdulVO" action="${pageContext.request.contextPath}/cop/smt/lsm/mng/updateLeaderSchdul.do" method="post">

<div class="wTableFrm">
	<!-- 타이틀 -->
	<h2><spring:message code="comCopSmtLsm.leaderSchdulModify.title" /></h2><!-- 간부일정관리 수정 -->
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="comCopSmtLsm.leaderSchdul.validate.schdulSe" /> <span class="pilsu">*</span></th>
			<td class="left">
		...
		<tr>
			...
			<td class="left">
				...
				<form:radiobutton path="reptitSeCode" value="2" onchange="viewEndDay('2')" onclick="viewEndDay('2')"/><spring:message code="comCopSmtLsm.leaderSchdulModify.everyday" /><!-- 매일 -->
				<form:radiobutton path="reptitSeCode" value="3" onchange="viewEndDay('3')" onclick="viewEndDay('3')"/><spring:message code="comCopSmtLsm.leaderSchdulModify.everyweek" /><!-- 매주 -->
				<form:radiobutton path="reptitSeCode" value="4" onchange="viewEndDay('4')" onclick="viewEndDay('4')"/><spring:message code="comCopSmtLsm.leaderSchdulModify.everymonth" /><!-- 매월 -->
		...
		<tr>
			...
			<td class="left">
			    <form:input path="schdulBgndeYYYMMDD"  size="10" maxlength="10" title="일정시작일자" cssStyle="width:78px" />
				<span id="endDay">~
				<form:input path="schdulEnddeYYYMMDD" size="10" maxlength="10" title="일정종료일자" cssStyle="width:78px"/>&nbsp;
				</span>
				
				<form:select path="schdulBgndeHH" title="일정시작 시 선택">
					<form:options items="${schdulBgndeHH}" itemValue="code" itemLabel="codeNm"/>
				</form:select><spring:message code="comCopSmtLsm.leaderSchdulDetail.hour" />
				<form:select path="schdulBgndeMM" title="일정시작 분 선택">
					<form:options items="${schdulBgndeMM}" itemValue="code" itemLabel="codeNm"/>
				</form:select><spring:message code="comCopSmtLsm.leaderSchdulDetail.minute" />
				~
		...
		<tr>
			...
			<td class="left">
			    <form:input path="schdulChargerName" readonly="true" maxlength="10" title="담당자명" cssStyle="width:98px" />
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input class="s_submit" type="submit" value='<spring:message code="button.save" />' onclick="fn_egov_save_LeaderSchdul(document.forms[0]); return false;" />
