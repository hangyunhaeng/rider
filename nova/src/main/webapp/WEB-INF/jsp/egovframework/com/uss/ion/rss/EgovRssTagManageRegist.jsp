...
function fn_egov_ColumnSetting_RssTagManage(column){
	...
	if( document.getElementById("tableColumn").selectedIndex > -1){
		...
		if( regTest.test(document.getElementById(column).value) ){
			alert(sColumnNm + " <spring:message code="ussIonRss.rssTagManageRegist.validate.Duplicate"/>");/* 컬럼명이 중복 되었습니다! */
			return;
		}else{
...
<div class="wTableFrm">
	<!-- 타이틀 -->
	<h2><spring:message code="ussIonRss.rssTagManageRegist.rssTagManageRegist"/></h2><!-- RSS태그관리 등록 -->
	...
	<table class="wTable mb10">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.trgetSvcNm"/> <span class="pilsu">*</span></th><!-- 대상서비스명  -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.trgetSvcTable"/> <span class="pilsu">*</span></th><!-- 대상테이블명 -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.hderTitle"/> <span class="pilsu">*</span></th><!-- 헤더TITLE -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.hderLink"/> <span class="pilsu">*</span></th><!-- 헤더LINK -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.hderDescription"/> <span class="pilsu">*</span></th><!-- 헤더DESCRIPTION -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.hderTag"/></th><!-- 헤더TAG -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.hderEtc"/></th><!-- 헤더ETC -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.tableColumn"/></th><!-- 컬럼 -->
			<td class="left">
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.bdtTitle"/> <span class="pilsu">*</span></th><!-- 본문TITLE -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.bdtLink"/> <span class="pilsu">*</span></th><!-- 본문LINK -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.bdtDescription"/> <span class="pilsu">*</span></th><!-- 본문DESCRIPTION -->
			<td class="left">
		...
		<tr>
			<th><spring:message code="ussIonRss.rssTagManageRegist.bdtEtc"/></th><!-- 본문ETC -->
			<td class="left">
