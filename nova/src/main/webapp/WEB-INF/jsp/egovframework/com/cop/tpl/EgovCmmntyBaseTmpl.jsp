        ...
        <td><table>
          <tr>
            <td align="center"><table>
              <tr>
                <td height="74" align="left" class="bgB"><table>
                  <tr>
    ...
    <td><table  >
      <tr>
        ...
        <td width="169" valign="top"><table>
          ...
          <tr>
            <td align="center" class="meMid"><table>
              <tr>
                <td align="left"><table  >
                  <tr>
		...
		<c:when test="${preview == 'true'}">
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" onload="javascript:calcHeight();" src="<c:url value='/cop/cmy/previewCmmntyMainContents.do'/>" width="758" height="480" title="컨텐츠영역"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:when>
        <c:otherwise>
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" onload="javascript:calcHeight();" src="<c:url value='/cop/cmy/CmmntyMainContents.do'/>?cmmntyId=<c:out value='${cmmntyVO.cmmntyId}' />" width="758" height="480" title="컨텐츠영역"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:otherwise>
        </c:choose>
          <br />
