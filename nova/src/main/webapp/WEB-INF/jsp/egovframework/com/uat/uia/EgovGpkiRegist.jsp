...
<table>
     ...
     <tr>
	<td width="40%"class="title_left"><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="제목아이콘이미지">&nbsp;인증서 DN 추출</td>
     </tr>
     <tr>
		  ...
		  <tr>
		  	<td>
				  ...
				  <tr>
					...
					<td background="<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><div><a href="javascript:LoginEmbedded(document.GpkiLoginForm);">DN값 추출</a></div></td>
					<td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지">
	                <input type="hidden" name="challenge" value='<c:out value="${challenge}"/>'></td>
	              </tr>
	              <tr>
		           <td class="required_text">DN값&nbsp;&nbsp;
		           <input type="text" size="13" maxlength="16" name="dn" value='<c:out value="${dn}"/>' title="DN값입력">&nbsp;&nbsp;
			       <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_left.gif' />" width="8" height="20" alt="버튼이미지"></td>
			       <td background="<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><div><a href="javascript:sendDn();">DN값 전달</a></div></td>
