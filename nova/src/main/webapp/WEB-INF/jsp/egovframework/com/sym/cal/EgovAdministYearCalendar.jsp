...
<form name="administYearCalendar" action ="<c:url value='/sym/cal/EgovAdministYearCalendar.do'/>" method="post">
	...
	<table  class="table-search">
	  <tr>
	    <td width="400" class="title_left"><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="제목아이콘이미지">&nbsp;행정달력 연간</td>
	  	<td>
...
<!-- 1월 시작 -->
	<table  class="table-search" style={top-margin:30;}>
	  <tr>
...
<!-- 12월 종료 -->
	<table  class="table-search" style={height:50px;}>
	  <tr>
