	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		$("#조회버튼").on("click", function(e){
		    ...
		    // 폼 데이터를 생성
			    ...
			    axios.post('${pageContext.request.contextPath}/com/com0006_0001.do', params)
			        .then(response => {
						...
						if(response.data.resultCode == "success"){
							location.replace("${pageContext.request.contextPath}/com/com0007.do");
						}
			        })
			        .catch(error => {
...
<!--           </div> -->
          ...
          <div class="col-lg-8">
            <div name="조회폼" id="조회폼" action="<c:url value='/com/com0006_0001.do' />" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
              <div class="row gy-4">
