	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		$("#비밀번호등록버튼").on("click", function(e){
		    ...
		    // 폼 데이터를 생성
			    ...
			    axios.post('${pageContext.request.contextPath}/com/com0007_0001.do', params)
			        .then(response => {
            ...
            <div name="조회폼" id="조회폼" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
              <div class="row gy-4">
                ...
                <div class="col-md-12 text-center">
                  ...
                  <button id="비밀번호등록버튼" type="submit">비밀번호등록</button>
                </div>
