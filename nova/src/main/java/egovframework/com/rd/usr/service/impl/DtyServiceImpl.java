				...
				if(rowObj != null) {
					...
					if(rowSize > 10) {
						...
						if(rowSize == 27) {
							...
							weekRiderInfoVO.setCnt(Integer.parseInt(Util.getOnlyNumberM(getValue(rowObj.getCell(3)))));
							weekRiderInfoVO.setDeliveryCost(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(4)))));
							weekRiderInfoVO.setAddCost(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(5)))));
							weekRiderInfoVO.setSumCost(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(6)))));
							weekRiderInfoVO.setTimeInsurance(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(7)))));
							weekRiderInfoVO.setNecessaryExpenses(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(8)))));
							weekRiderInfoVO.setPay(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(9)))));
							weekRiderInfoVO.setOwnerEmploymentInsurance(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(10)))));
							weekRiderInfoVO.setRiderEmploymentInsurance(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(11)))));
							weekRiderInfoVO.setOwnerIndustrialInsurance(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(12)))));
							weekRiderInfoVO.setRiderIndustrialInsurance(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(13)))));
							weekRiderInfoVO.setWithholdingTaxInsuranceSum(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(14)))));
							weekRiderInfoVO.setOwnerEmploymentInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(15)))));
							weekRiderInfoVO.setRiderEmploymentInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(16)))));
							weekRiderInfoVO.setSumEmploymentInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(17)))));
							weekRiderInfoVO.setOwnerIndustrialInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(18)))));
							weekRiderInfoVO.setRiderIndustrialInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(19)))));
							weekRiderInfoVO.setSumIndustrialInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(20)))));
							weekRiderInfoVO.setOperatingCost(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(21)))));
							weekRiderInfoVO.setAccountsCost(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(22)))));
							weekRiderInfoVO.setIncomeTax(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(23)))));
							weekRiderInfoVO.setResidenceTax(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(24)))));
							weekRiderInfoVO.setWithholdingTax(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(25)))));
							weekRiderInfoVO.setGivePay(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(26)))));
						...
						if(rowSize == 26) {	//운영비가 빠졌음
							...
							weekRiderInfoVO.setSumIndustrialInsuranceAccounts(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(20)))));
							weekRiderInfoVO.setOperatingCost(new BigDecimal( 0 ));
							weekRiderInfoVO.setAccountsCost(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(21)))));
							weekRiderInfoVO.setIncomeTax(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(22)))));
							weekRiderInfoVO.setResidenceTax(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(23)))));
							weekRiderInfoVO.setWithholdingTax(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(24)))));
							weekRiderInfoVO.setGivePay(new BigDecimal(Util.getOnlyNumberM(getValue(rowObj.getCell(25)))));
							weekRiderInfoVO.setCreatId(user.getId());
							insertData.add(weekRiderInfoVO);
						}
...
//			value = cell.getCellFormula();
	...
	public DoszTransferVO actDayPay(DayPayVO vo) throws Exception {
		...
		//영업사원 수익등록(선지급)
		if(resultFee.getFeeSalesmanCost() > 0) {
	...
	public DoszTransferVO transfer(DoszTransferVO vo) throws Exception {
        ...
        if(!Util.isEmpty(responseData)) {
	        ...
	        if("200".equals(vo.getStatus()) ) {
		        ...
		        dtyDAO.selectForUpdateBalanceDayTran(vo);	//협력사와 영업사원 db lock
//		        dtyDAO.updateBalanceDayTran(vo);
		        ...
		        //영업사원 잔액 조정
		        if(salesProfitVO != null) {
		    		setBalance(EgovProperties.getProperty("Globals.cooperatorId"), salesProfitVO.getEsntlId(), salesProfitVO.getEmplyrId(), user.getId(), new BigDecimal(0), new BigDecimal(salesProfitVO.getCost()));
		        }
	        }
	...
	public void updateDayPayByTransfer(DoszTransferVO vo) throws Exception {
		...
		dtyDAO.selectForUPdateBalanceByDayTran(vo);
		// 잔액 조정
		dtyDAO.updateBalanceDayPayByTransfer(vo);
	...
	public int updateWeekPayByTransfer(DoszTransferVO vo) throws Exception {
		...
		//0. 사용자 select for update 로 rock
		dtyDAO.selectForUPdateBalanceByWeekTran(vo);
		// 잔액 조정
		dtyDAO.updateBalanceWeekPayByTransfer(vo);
		// 출금이력 삭제
	...
	public void fixDay(DeliveryInfoVO deliveryInfoVO) throws Exception {
		...
		//2. 수익 등록
		DayPayVO inVo = new DayPayVO();
		inVo.setSearchFromDate(deliveryInfoVO.getSearchFromDate());
		inVo.setSearchToDate(deliveryInfoVO.getSearchToDate());
		inVo.setSearchNm(deliveryInfoVO.getSearchNm());
		inVo.setSearchGubun(deliveryInfoVO.getSearchGubun());
		inVo.setTimeInsuranceMaxFee(Integer.parseInt(EgovProperties.getProperty("Globals.timeInsuranceMaxFee")) );
    	...
    	for(int i = 0 ; i<dayList.size() ; i++) {
    		...
    		if(one.getFeeProgramSalesmanCost() > 0) {
		        ...
		        //영업사원 잔액 조정
	    		setBalance(EgovProperties.getProperty("Globals.cooperatorId"), one.getSalesEsntlId(), one.getEmplyrId(), user.getId(), new BigDecimal(0), new BigDecimal(one.getFeeProgramSalesmanCost()));
    		}
...
//        	List<WeekRiderInfoVO> weekRiderInfoList = dtyDAO.selectWeekRiderInfoByAtchFileId(weekInfoVO);
	...
	public void setBalance(String CoopId, String esntlId, String mberId, String mdfId, BigDecimal balance0, BigDecimal balance1) throws Exception {
		...
		if(dtyDAO.selectBalanceById(mberBalance) == null) {
			...
			if(EgovProperties.getProperty("Globals.cooperatorId").equals(esntlId) ) {
	    		...
	    		MyInfoVO ablePriceForBal = payDAO.salesAblePrice(ableVo);
	    		mberBalance.setBalance0(new BigDecimal(0) );
	    		mberBalance.setBalance1(new BigDecimal(ablePriceForBal.getSalesAblePrice()) );
			} else {
				//라이더
	    		//1.출금 가능금액 내의 금액인지 확인
	    		MyInfoVO ableVo = new MyInfoVO();
	...
	public List<WeekInfoVO> selectWeekInfoOutByParam(WeekInfoVO vo) throws Exception {
		return dtyDAO.selectWeekInfoOutByParam(vo);
	}
