...
public class ActInfoVO extends ActInfo implements Serializable  {
    ...
    private List<ActInfo> actInfo = new ArrayList<>(); // 재원별예산

    // fndBdgInfo 필드에 대해 불변 리스트를 반환하는 setter 메서드
    public void setActInfo(List<ActInfo> actInfo) {
        this.actInfo = Collections.unmodifiableList(actInfo);
    }
