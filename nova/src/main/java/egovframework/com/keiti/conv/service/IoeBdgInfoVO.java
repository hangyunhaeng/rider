...
public class IoeBdgInfoVO extends IoeBdgInfo implements Serializable  {
    ...
    private List<IoeBdgInfo> ioeBdgInfo = new ArrayList<>(); // 비목별예산

    // ioeBdgInfo 필드에 대해 불변 리스트를 반환하는 setter 메서드
    public void setIoeBdgInfo(List<IoeBdgInfo> ioeBdgInfo) {
        this.ioeBdgInfo = Collections.unmodifiableList(ioeBdgInfo);
    }
