...
public class ExecFileInfoVO extends ExecFileInfo implements Serializable  {
	...
	private List<ExecFileInfo> execFileInfo = new ArrayList<ExecFileInfo>(); // 과제정보
