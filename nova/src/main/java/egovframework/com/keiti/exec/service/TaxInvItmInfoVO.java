...
public class TaxInvItmInfoVO extends TaxInvItmInfo implements Serializable  {
	...
	private List<TaxInvItmInfo> taxInvItmInfo = new ArrayList<TaxInvItmInfo>(); // 과제정보
