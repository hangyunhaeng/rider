...
public class LoginVO implements Serializable{
	...
	/**
	 * GNR사용자가 직접 로그인 하여 패스워드 등록 했는지 여부를 리턴
	 * @return
	 */
	public String getMberConfirmAt() {
		return mberConfirmAt;
	}

	/**
	 * GNR사용자가 직접 로그인 하여 패스워드 등록 했는지 여부를 설정
	 * @return
	 */
	public void setMberConfirmAt(String mberConfirmAt) {
		this.mberConfirmAt = mberConfirmAt;
	}
